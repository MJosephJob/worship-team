...
export default function EventsPage() {
  ...
  async function load() {
    ...
    try {
      ...
      setEvents(Array.isArray(e) ? e.sort((a,b) => new Date(b.date) - new Date(a.date)) : [])
      setMembers(Array.isArray(m) ? m.filter(x => x.isActive !== false) : [])
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <PageHeader
        title="Events"
        subtitle="Track events & attendance"
        actions={
